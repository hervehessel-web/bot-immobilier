...
def load_statbel_real_estate():
    """
    V5.1.2: local-first Statbel loader.
...
with tintegrations:
    ...
    st.caption("V5.1.2 : données Statbel chargées localement depuis GitHub — plus de dépendance au téléchargement direct depuis Streamlit Cloud.")
